        ...
        <div id="comp_lst_area">
          <ul class="comp_lst flex fxwrap">
            ...
            <li class="store_list" v-for="(item, index) in state.storeList" :key="index">
              <div class="store_info">
                <div class="store_no" @click="goStoreList(item.storeNo)"
                  style="cursor: pointer; border: 1px solid #ddd;border-radius: 10px;">
                  {{ item.storeNo }}
                </div>
                <div class="store_name">
                ...
                <div class="store_id">
                  <input type="text" class="wrt_ipt" v-model="item.storeId"
                    style="background: #dcdcdc; cursor:not-allowed" readonly="readonly">
                </div>
                <div class="store_pass">
                ...
                <div class="store_btn">
                  ...
                  <button class="btn_blue w40 inner260" @click="qrOpenYn(item.storeNo)">QR</button>
                </div>
              </div>

              <div class="qr_img" v-if="item.QROpen" @click="item.QROpen = false">
                <div style="text-align: right;font-size: large;"><i style="margin:0" class="bi bi-x-square-fill"></i>
                </div>
                <img :src="item.QRcode">
              </div>
            </li>
